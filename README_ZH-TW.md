...
資料分析／商業分析工作者，具製造、供應鏈與財務風險管理實務。能從使用者需求釐清與作業流程理解出發，運用 Python、SQL、Power BI 及 Power Platform 完成跨系統資料整合、流程自動化與管理報表。代表成果包括每月自動拋轉約 **1 億美元的外匯交易總金額**，以及支援超過 **50 種原料、每月約新台幣 10 億元**成本規模的管理系統。
